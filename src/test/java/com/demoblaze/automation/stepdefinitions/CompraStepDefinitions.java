    ...
    public void abrirPagina() {
        ...
        OnStage.theActorInTheSpotlight().attemptsTo(
                ...
                Login.conCredenciales(
                        Serenity.environmentVariables().getProperty("app.usuario"),
                        Serenity.environmentVariables().getProperty("app.password")
                )
        );
    }

    @When("agrega el producto {string} de la categoria {string} al carrito")
    public void agregarProductos(String producto, String categoria) {
        OnStage.theActorInTheSpotlight()
                .attemptsTo(AgregarProductos.alCarrito(producto, categoria));
    }
